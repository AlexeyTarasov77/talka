...
//
//	mockgen -source=postgres.go -destination=./mocks_postgres_test.go -package=repo_test
//
...
import (
	...
	postgres "github.com/AlexeyTarasov77/messanger.users/internal/gateways/storage/postgres"
